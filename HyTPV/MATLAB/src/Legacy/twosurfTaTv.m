...
function [Q_aero,Q_vehicle,W_total]=...
    twosurfTaTv(l_1em,e_1em,l_2pv,e_2pv,l_gap,T_aer,T_veh)
...
E_1=@(lam) specEbb(T_aer,lam);

E_2=@(lam) specEbb(T_veh,lam);
